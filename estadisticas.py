...
class Estadisticas:
    ...
    def actualizar_estadisticas(self, so2_datos, part_datos, no2_datos, co_datos, o3_datos):
        self.so2_media = numpy.mean(so2_datos)
        self.n_medio_part = numpy.mean(part_datos)
        self.no2_media = numpy.mean(no2_datos)
        self.co_media = numpy.mean(co_datos)
        self.o3_media = numpy.mean(o3_datos)
